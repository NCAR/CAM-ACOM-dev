...
module chem_mods
  ...
  real(kind=r8), parameter :: adv_mass = (/ &
          ...
          1.0074000000000001, 1.0074000000000001, 1.0074000000000001, 1.0074000000000001, &
          12.010999999999999, 12.010999999999999, 64.064800000000005, 115.10733999999999, &
          115.10733999999999, 115.10733999999999, 12.010999999999999, 12.010999999999999, &
          12.010999999999999, 12.010999999999999, 18.014199999999999 /)
...
module physconst
  ...
  implicit none
  public :: mwdry, gravit
  real(kind=shr_kind_r8), parameter :: mwdry = -999.0
  real(kind=shr_kind_r8), parameter :: gravit = 9.7976399999999995
...
module mo_constants
  ...
  implicit none
  public :: pi
  real(kind=shr_kind_r8), parameter :: pi = 3.1415926535897931
