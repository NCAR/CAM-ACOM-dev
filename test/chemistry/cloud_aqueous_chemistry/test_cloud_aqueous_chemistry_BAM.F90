...
! No invariants are needed for BAM
#define NO_INVARIANTS
  ...
  integer, parameter :: n_invariants = 4
  integer, parameter :: n_species = 103
  integer, parameter :: n_modes = 1

#ifndef NO_INVARIANTS
  integer, parameter :: needed_invariant_indices(0) = (/ /)
#endif
  integer, parameter :: needed_species_indices(*) = (/ 1, 8, 13, 14, 83, 85, 86 /)

  character(len=*), parameter :: data_file = &
      '../test/chemistry/data/QPMOZ-f10_f10_mg37-cloud-chemistry-mod.cam.h1i.0001-01-01-05400.nc'
...
! These outputs are never calculated in the original BAM code
#if 0
